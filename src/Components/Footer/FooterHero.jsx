...
export default function FooterHero() {
  return (
    <section className="relative w-full text-white max-w-7xl mx-auto md:mt-20 md:px-20">
      <div className="max-w-7xl mx-auto bg-[#0c0c0c] rounded-3xl md:rounded-4xl overflow-hidden relative z-20 shadow-xl">
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between px-8 lg:px-14 py-10">
          <div className="flex-1 max-w-xl">
            ...
            <Link
              to="/Contact-Us"
              className="px-6 py-3 bg-white text-black rounded-lg text-sm font-semibold hover:bg-gray-200 transition inline-block"
            >
              Get in Touch
            </Link>
          </div>
