...
//   return (
//     <div className="px-6 md:px-12 py-16 md:mt-15">
//       <h4 className="font-bold text-sm tracking-wide  mb-14 font-serif">
//         03. Services Offered
//       </h4>
...
//               <h3 className="-tracking-4 font-serif pt-0.5  text-xl/[1.375rem] font-semibold text-balance text-black md:text-1xl/[1.875rem] ">
//                 {title}
//               </h3>
//               <h2 className="font-sans text-sm/[1.125rem] text-black md:text-base/[1.375rem] dark:text-neutral-600 [&_b]:md:font-semibold [&_strong]:md:font-semibold">
//                 {description}
//               </h2>
//             </div>
//           </div>
      ...
      <div className="relative h-full rounded-2xl border border-gray-300 p-2 md:rounded-3xl md:p-3">
        ...
        <div className="border-gray-200 relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-xl p-6 md:p-6">
          <div className="relative flex flex-1 flex-col justify-between gap-3">
            ...
            <div className="space-y-3">
              <h3 className="-tracking-4 font-serif pt-0.5 text-xl/[1.375rem] font-semibold text-black md:text-1xl/[1.875rem]">
                {title}
              </h3>
