...
export default function HeavyLiftHome() {
  return (
    <section className="relative text-black font-sans md:mt-10 mt-5 overflow-hidden">
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-16 relative">
        <div className="grid grid-cols-12 gap-6 items-start">
          <div className="col-span-12 lg:col-span-7">
            <h1
              data-aos="fade-right"
              className=" font-new font-black leading-snug text-2xl sm:text-4xl md:text-5xl lg:text-5xl text-balance"
            >
              <span className="block text-[#7c0204]">
                Project &amp; Heavy Lift Cargo
              </span>
              Tailored Solutions for Oversized{" "}
              <span className="text-[#7c0204]">Shipments</span>
            </h1>
          </div>

          <div
            data-aos="fade-left"
            className="col-span-12 lg:col-span-5 flex lg:justify-end lg:mt-0"
          >
        ...
        <div className="grid grid-cols-12 gap-6 items-center mt-20">
          <div className="col-span-12 lg:col-span-6 relative">
            <div
              data-aos="zoom-in"
              className="bg-[#16a3e6] relative h-[340px] flex items-end bord justify-center p-6"
            >
              <img
                src={HeavyLift}
          ...
          <div data-aos="fade-up" className="col-span-12 lg:col-span-6">
            ...
            <div className="flex items-center gap-4 mt-8">
              <DynamicButton
                text={"Get Started"}
                scrollTo="heavy-services-scroll"
              />
            </div>
