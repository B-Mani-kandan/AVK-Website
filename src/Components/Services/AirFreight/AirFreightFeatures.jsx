...
import Aero from "../../../assets/AirFreight/Aero.webp";
...
const featuresRight = [
  ...
  },
  {
    ...
    desc: "Our support team is available at any time around the clock to assist with any queries or issues.",
  },
];

const AirFreightFeatures = () => {
  return (
    <section className="relative bg-[#04558c] text-white px-6 py-16 md:px-20 overflow-hidden">
